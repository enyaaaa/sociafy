              ...
              child: Column(
                children: [
                  ...
                  widget.post.caption != null
                      ...
                      child: Container(
                        child: ReadMoreText(widget.post.caption!,
                          trimLines: 2,
                          ...
                          Row(
                            children: [
                              IconButton(
                                ...
                                icon: SvgPicture.asset(widget.post.isliked ?"assets/icon/like_active_icon.svg" : "assets/icon/like_icon.svg" ,
                                  width: 27,),
                              ),
                              SizedBox(
                                width: 10,
                              ),
                              SvgPicture.asset("assets/icon/comment_icon.svg", width: 27,),
                            ],
                          ),
                          IconButton(
                            onPressed: () {
                            ...
                            icon: SvgPicture.asset(widget.post.issaved ? "assets/icon/save_active_icon.svg" : "assets/icon/save_icon.svg",
                              width: 27,),
                          )
                        ],
                      ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.asset(comment.user.image),
                                          ),
                                        ),
                                        SizedBox(width: 10,),
                                        Column(
                                    ...
                                    IconButton(
                                      ...
                                      icon: SvgPicture.asset(comment.isliked ?"assets/icon/like_active_icon.svg" : "assets/icon/like_icon.svg" ,
                                        width: 15,),
                                    ),
                                  ],
                                ),
